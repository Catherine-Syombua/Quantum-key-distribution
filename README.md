...
* High QBER: Strong evidence of interception — abort communication.[qkd_dense.py](https://github.com/user-attachments/files/23062050/qkd_dense.py)


5. Report and Visualization
The app provides:
* A QBER vs. noise plot for performance insight.[qkd_dense.py](https://github.com/user-attachments/files/23062054/qkd_dense.py)
import random
import numpy as np
